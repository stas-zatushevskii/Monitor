...
func ParseFlags() {
	...
	flag.StringVar(&DSN, "d", "postgres://postgres:123@localhost:5432/postgres?sslmode=disable", "database connection string") // postgres://postgres:123@localhost:5432/postgres?sslmode=disabl
